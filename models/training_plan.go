...
type TrainingPlan struct {
	...
	CompletionStatus string             `json:"completion_status" gorm:"size:50"`  // 完成情况
	KeyPlayerNotes   string             `json:"key_player_notes" gorm:"type:text"` // 重点球员表现
	NextFocus        string             `json:"next_focus" gorm:"type:text"`       // 下次训练重点
