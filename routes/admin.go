...
func SetupAdminRoutes(r *gin.RouterGroup, adminController *controllers.AdminController) {
	...
	authAdmin.Use(middleware.AdminRoleMiddleware())
	{
		...
		authAdmin.GET("/orders/:id/analysis-progress", perm("orders.manage"), adminController.GetOrderAnalysisProgress)
		authAdmin.POST("/orders/:id/analysis-progress/reminder", perm("orders.manage"), adminController.SendOrderProgressReminder)
		authAdmin.POST("/orders/:id/analysis-progress/exception", perm("exceptions.manage"), adminController.MarkOrderProgressException)
		authAdmin.POST("/orders/:id/analysis-progress/exception/resolve", perm("exceptions.manage"), adminController.ResolveOrderProgressException)
